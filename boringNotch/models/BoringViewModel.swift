...
class BoringViewModel: NSObject, ObservableObject {
    ...
    func close() {
        ...
        // Set the default closed/open view: shelf can still take priority, otherwise restore the user's last selected tab.
        if !ShelfStateViewModel.shared.isEmpty && Defaults[.openShelfByDefault] {
            coordinator.currentView = .shelf
        } else {
            coordinator.currentView = coordinator.rememberedViewForOpening()
        }
    }
